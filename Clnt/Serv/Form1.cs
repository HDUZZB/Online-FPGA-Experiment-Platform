...
namespace Serv
{
    public partial class frmClient : Form
    {
        ...
        void RecMsg(object sokConnectionparn)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    //ShowMsg(System.Text.Encoding.UTF8.GetString(arrMsgRec, 0, length));
        ...
        private void ShowMsg(byte[] arrMsgRec)
        {
